...
cv2.destroyAllWindows() # We destroy all the windows inside which the images were displayed.)  # To close the window where the face recognition were going on (the window on the laptop which is showing the face and eye detection)
